...
- `NEXT-1`: Execute `M7-CLOSE-001` (M7 stabilization sweep + release-note closeout).
- `NEXT-2`: Execute `M8-PLAN-001` (define executable M8 backlog and move active pointer).
